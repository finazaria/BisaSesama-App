...
urlpatterns = [
    ...
    path("penggalangan_dana/delete", delete_penggalangan_dana, name="delete_pdd"),
    path("penggalangan_dana/cairkan", cairkan_pdd, name="cairkan_pdd"),
    path("komorbid/create/", create_komorbid, name="create_komorbid"),
    path("komorbid/update/(?P<id>[^/]+)$/(?P<penyakit>[^/]+)$/", update_komorbid, name="update_komorbid"),
    path("komorbid/delete/(?P<id>[^/]+)$/(?P<komorbid>[^/]+)$/", delete_komorbid, name="delete_komorbid"),
